            ...
            <>
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1 px-3 py-1.5 text-xs rounded-full border border-white/10 hover:border-[#D6FF34]/30 text-white/60 hover:text-[#D6FF34] transition-colors"
                >
              ...
              <div className="space-y-4">
                {beneficiaries.map((ben, i) => (
                  <div key={i} className="p-5 rounded-[16px] bg-surface-2 space-y-3">
                    <div className="flex items-center justify-between">
                      <p className="text-[11px] font-bold uppercase tracking-[1.2px] text-white/45">Beneficiary {i + 1}</p>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        placeholder="0x..."
                        className="w-full px-3 py-2 bg-surface-3 border border-white/10 rounded-[8px] text-white text-sm font-mono focus:outline-none focus:border-[#D6FF34]/50"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-24 px-3 py-2 bg-surface-3 border border-white/10 rounded-[8px] text-white text-sm focus:outline-none focus:border-[#D6FF34]/50"
                      />
                    </div>
                  </div>
                ))}
                ...
                <div className="p-4 rounded-[16px] bg-surface-2">
                  ...
                  <div className="text-xs text-white/60 space-y-1">
                    ...
                    <p>
                      ...
                      <span className="text-[#D6FF34] font-bold">
              ...
              <div className="space-y-4">
                <div className="p-5 rounded-[16px] bg-surface-2 space-y-3">
                  <div className="flex justify-between">
                    <span className="text-[11px] font-bold uppercase tracking-[1.2px] text-white/45">Network</span>
                    <span className="text-sm text-white">Filecoin Calibration</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-[11px] font-bold uppercase tracking-[1.2px] text-white/45">Beneficiaries</span>
                    <span className="text-sm text-white">{beneficiaries.length}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-[11px] font-bold uppercase tracking-[1.2px] text-white/45">Check-in Interval</span>
                ...
                <div className="space-y-2">
                  ...
                  {beneficiaries.map((b, i) => (
                    <div key={i} className="flex justify-between p-3 rounded-[8px] bg-surface-2">
                      ...
                      <span className="text-xs text-[#D6FF34] font-bold">{b.percentage}%</span>
                    </div>
                  ))}
                </div>
