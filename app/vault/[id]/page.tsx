...
export default function VaultDetailPage() {
  ...
  const handleCheckIn = async () => {
    if (!signer) {
      toast.error('Connect EVM wallet to check in');
      return;
    }
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="flex items-start justify-between">
              ...
              {vault.statusLabel === 'Active' && fhevmWallet.isConnected && vault.owner === fhevmWallet.address && (
                <button
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className={`bg-surface-1 rounded-[20px] p-6 border-t-2 ${getStatusBorderColor(vault.statusLabel)}`}>
                ...
                <p className="text-stat-label">Vault Status</p>
              </div>
              <div className={`bg-surface-1 rounded-[20px] p-6 border-t-2 ${getStatusBorderColor(vault.statusLabel)}`}>
                ...
                <p className="text-stat-label">Check-in Interval</p>
              </div>
              <div className={`bg-surface-1 rounded-[20px] p-6 border-t-2 ${getStatusBorderColor(vault.statusLabel)}`}>
            ...
            <div className="bg-surface-1 rounded-card p-10 space-y-4">
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="flex justify-between">
                  <span className="text-stat-label">Legacy Documents</span>
            ...
            <div className="flex flex-wrap gap-3">
              <Link
                ...
                className="text-button inline-flex items-center gap-2 bg-surface-2 rounded-full px-6 py-2.5 text-text-primary hover:opacity-80"
              >
