        ...
        <div className="bg-surface-1 rounded-[30px] p-10 space-y-6">
          ...
          <div className="flex items-center justify-between bg-surface-2 rounded-[16px] p-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-medium text-white">EVM (Calibration)</p>
                {fhevmWallet.isConnected ? (
                  <>
                    <p className="text-xs text-white/40 font-mono">{fhevmWallet.address.slice(0, 16)}...{fhevmWallet.address.slice(-6)}</p>
            ...
            {fhevmWallet.isConnected ? (
              ...
              <button
                ...
                className="bg-yo-yellow text-black rounded-full px-6 py-2 text-[13px] font-bold uppercase tracking-[0.96px]"
              >
                Connect
              </button>
            )}
        ...
        <div className="bg-surface-1 rounded-[30px] p-10 space-y-4">
          ...
          <div className="text-sm space-y-2">
            <div className="flex justify-between">
              <span className="text-white/60">EVM Network</span>
            ...
            <div className="flex justify-between">
              ...
              <a
                ...
                className="text-yo-yellow hover:underline"
              >
